...
// // Updates 更新实体
// func (b *BaseRepository) Updates(model repository_impl{}, value repository_impl{}) error {
...
// DeleteByID 根据id删除实体
func (b *BaseRepository) DeleteByID(model interface{}, id int64) error {
	return b.Source.DB().Where("id=?", id).Delete(model).Error
}

// DeleteByIDS 根据多个id删除多个实体
func (b *BaseRepository) DeleteByIDS(model interface{}, ids []int64) (count int64, err error) {
...
func (b *BaseRepository) FirstByID(out interface{}, id int64) error {
...
// GetPages 分页返回数据
func (b *BaseRepository) GetPages(model interface{}, out interface{}, pageIndex, pageSize int64, totalCount *uint64, where interface{}, orders ...string) error {
